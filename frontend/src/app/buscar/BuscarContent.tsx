          ...
          <div className="card p-5 sticky top-20">
            ...
            <div className="mb-6">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" checked={filters.home_service}
                  onChange={e => set('home_service', e.target.checked)} className="w-4 h-4 rounded" />
                ...
                <Link key={pro.id} href={`/profissional/${pro.id}`}
                  ...
                  <div className="h-44 flex items-center justify-center text-6xl relative"
                    ...
                    {pro.avatar_url
                      ...
                      : <span>{['🌿','💆','🧘','✨','💐','🌸'][Math.abs((pro.name?.charCodeAt(0) || 0)) % 6]}</span>
                    }
                    {pro.plan === 'pro' && (
